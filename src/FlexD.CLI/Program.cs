...
[assembly: InternalsVisibleTo("FlexD.CLI.Tests")]
...
internal class Program
{
  ...
  internal static async Task<int> Main(string[] args)
  {
    ...
    Log.Logger = new LoggerConfiguration()
      ...
      .WriteTo.File(Path.Combine(AppContext.BaseDirectory, "flexd.log"), LogEventLevel.Information)
    ...
    return new HostBuilder()
      ...
      .ConfigureServices((hostConfig, services) =>
      {
        ...
        services.Scan(c =>
        {
          ...
          c.FromAssemblyOf<IHttpCommandOptions>()
            .AddClasses(x => x.NotInNamespaceOf(typeof(RequestPerformanceBehaviour<,>))
              .Where(type => type.Namespace != null && type.Namespace.Contains("FlexD")))
            .AsImplementedInterfaces()
            .WithTransientLifetime();
